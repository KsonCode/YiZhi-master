...
public class HomeFragment extends BaseMVPCompatFragment<HomeMainContract.HomeMainPresenter,
    ...
    public void showTabList(String[] tabs) {
        ...
        for (int i = 0; i < tabs.length; i++) {
            ...
            switch (i) {
                case TabFragmentIndex.TAB_TUIJIAN_INDEX:
                    fragments.add(ZhihuFragment.newInstance());
                    break;
                case TabFragmentIndex.TAB_BIHU_INDEX:
                    fragments.add(WangyiFragment.newInstance());
                    break;
                case TabFragmentIndex.TAB_HANGQING_INDEX:
        ...
        vpFragment.setCurrentItem(TabFragmentIndex.TAB_TUIJIAN_INDEX);//要设置到viewpager.setAdapter后才起作用
        tlTabs.setupWithViewPager(vpFragment);
        tlTabs.setVerticalScrollbarPosition(TabFragmentIndex.TAB_TUIJIAN_INDEX);
